...
def run_react_agent(user_query: str, provider):
    ...
    for step in range(1, MAX_ITERATIONS + 1):
        ...
        if tool_name is None:
            ...
            print("Trả lời: Xin lỗi, mình chưa xử lý được yêu cầu này. Bạn thử hỏi lại rõ hơn nhé.")
            return
    ...
    print("Trả lời: Xin lỗi, mình chưa tra được thông tin bạn cần. "
          "Bạn kiểm tra lại thông tin đã nhập hoặc liên hệ phòng đào tạo giúp mình nhé.")
